...
import type { TaskPriority, TaskStatus, Label } from '../../../shared/types';
...
export function TaskCreateModal({ onClose, defaultStatus }: TaskCreateModalProps) {
          ...
          <div className="w-72 border-l border-border p-6 space-y-6 bg-surface-0/50 overflow-y-auto">
            ...
            <div className="pt-2">
              <button
                ...
                disabled={!title.trim()}
                className="w-full px-4 py-2 text-sm bg-accent text-white rounded-lg hover:bg-accent-hover disabled:opacity-50 transition-colors font-medium"
              >
                Create
              </button>
            </div>
